...
import heroImage from "@/assets/ambiti/pizzerie-hero.jpg";
...
const problemi = [
  { icon: Flame, testo: "Fumi neri e densi che escono dalla canna fumaria, visibili dall'intera via" },
  { icon: Building2, testo: "Fuliggine e residui di combustione su balconi, finestre e auto dei vicini" },
  { icon: Volume2, testo: "Lamentele costanti dal vicinato e segnalazioni ASL per odori molesti" },
  { icon: Ban, testo: "Rischio di sanzioni, diffide e chiusura per emissioni fuori norma" },
  { icon: AlertTriangle, testo: "Tiraggio insufficiente con fumo che rientra in sala e disturba i clienti" },
];

const vantaggiSoluzione = [
  { icon: Droplets, titolo: "Abbattimento ad acqua", desc: "La tecnologia wet scrubber ZAPPER® cattura fuliggine, particolato e odori con acqua atomizzata. Nessun filtro da sostituire." },
  { icon: Shield, titolo: "Zero filtri elettrostatici", desc: "Niente filtri che si intasano, nessun rischio incendio. Solo acqua e una pulizia periodica semplice e veloce." },
  { icon: Wrench, titolo: "Installazione in giornata", desc: "Si collega alla canna fumaria esistente del forno. Nessuna modifica strutturale, nessun fermo dell'attività." },
];

const modelliCompatibili = [
  { name: "ZPZ", desc: "Per forni a legna di media portata (Ø 200–250 mm)", href: "/modelli/zpz" },
  { name: "ZPZ MAX", desc: "Per forni ad alta portata e uso intensivo (Ø 300–350 mm)", href: "/modelli/zpz-max" },
  { name: "DESTINK", desc: "Abbattimento odori per pizzerie con forno elettrico (Ø 250–300 mm)", href: "/modelli/destink" },
];

const casiClienti = [
  {
    titolo: "Pizzeria Centro Storico", citta: "Napoli",
    problema: "Fumi neri visibili e segnalazioni ASL ripetute, rischio chiusura imminente",
    risultato: "Emissioni abbattute del 95%, zero segnalazioni in 18 mesi",
    modello: "ZPZ MAX"
  },
  {
    titolo: "Pizzeria da Asporto", citta: "Milano",
    problema: "Odori forti nel condominio sovrastante con causa civile in corso",
    risultato: "Nessuna lamentela, causa ritirata dopo 3 mesi",
    modello: "ZPZ"
  },
  {
    titolo: "Pizzeria Gourmet", citta: "Firenze",
    problema: "Fuliggine su terrazzi e lenzuola stese, rapporti con i vicini compromessi",
    risultato: "Emissioni invisibili, rapporti con il vicinato ristabiliti",
    modello: "ZPZ MAX"
  },
];
...
export default function Pizzerie() {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Pizzerie – Abbattimento Fumi e Odori dal Forno | ZAPPER®"
        description="Elimina fumi neri, fuliggine e odori dalla tua pizzeria con la tecnologia wet scrubber ZAPPER®. Installazione in giornata, zero filtri, risultati garantiti."
      />
      <Header />
      <main>
        {/* ═══ 1. HERO ═══ */}
        ...
        >
          ...
          <div className="container relative z-10">
            <nav className="flex items-center gap-2 text-sm text-primary-foreground/50 mb-8">
              ...
              <span>/</span>
              <span className="text-primary-foreground/80">Pizzerie</span>
            </nav>
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-destructive/20 border border-destructive/30 rounded-full mb-6">
                ...
                <span className="text-sm font-medium text-primary-foreground/90">Fumi, fuliggine e odori dalla tua pizzeria?</span>
              </div>
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6 leading-tight">
                Elimina fumi e odori dalla tua pizzeria.
                <span className="text-accent"> Per sempre.</span>
              </h1>
              <p className="text-lg md:text-xl text-primary-foreground/80 mb-8 max-w-2xl">
                ZAPPER® abbatte il 95% delle emissioni da forni a legna e elettrici con tecnologia ad acqua. Nessun filtro, installazione in giornata.
              </p>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg">
                La maggior parte dei titolari di pizzerie affronta almeno uno di questi problemi ogni giorno.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-muted/30">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg">
                Un sistema che si installa sulla canna fumaria del forno e abbatte fumi, fuliggine e odori con acqua atomizzata ad alta pressione.
              </p>
            </div>
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto mb-16">
              <div>
                <img src={soluzioneImage} alt="Sistema ZAPPER® per pizzerie" className="rounded-2xl shadow-2xl w-full" loading="lazy" width={1280} height={864} />
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <img src={primaDopoImage} alt="Prima e dopo ZAPPER® in pizzeria" className="rounded-2xl shadow-xl w-full" loading="lazy" width={1280} height={640} />
          ...
          <div className="container">
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              <div className="order-2 lg:order-1">
                ...
                <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mt-3 mb-4">
                  Installato in giornata, senza fermare la pizzeria
                </h2>
                <p className="text-muted-foreground text-lg mb-6">
                  I nostri partner certificati intervengono in tutta Italia. Il forno non si ferma mai.
                </p>
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">Inviaci foto della canna fumaria e del forno. Valutiamo diametro, portata e contesto.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
              ...
              <div className="order-1 lg:order-2">
                <img src={installazioneImage} alt="Installazione ZAPPER® in pizzeria" className="rounded-2xl shadow-2xl w-full" loading="lazy" width={1280} height={864} />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-muted/30">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mt-3 mb-4">
                Quale ZAPPER® per la tua pizzeria?
              </h2>
              <p className="text-muted-foreground">
                Il modello corretto viene confermato in base al tipo di forno, al diametro della canna fumaria e alla portata.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mt-3 mb-4">
                Pizzerie che hanno risolto con ZAPPER®
              </h2>
              <p className="text-muted-foreground">Interventi documentati su pizzerie in tutta Italia.</p>
            </div>
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="font-display text-3xl md:text-4xl font-bold text-primary-foreground mb-4">
                La tua pizzeria ha problemi di fumi o odori?
              </h2>
